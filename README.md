...
>This project is a Ruby on Rails project. The exercise is based on building an application where users can write posts and can only see which user wrote the post if the user is signed into the application.
...
```
$ git clone git@github.com:jacobrees/Members-Only.git
```
